...
#   found in the book "Naked Statistics". it explores
#   "Expected Values". if given the opportunity to play
#   a game in which you roll a 6-sided die, and get paid 
#   $1 if you roll a one, $2 if you roll a two, etc, and
#   each attempt at the game costs $3, is it worth it?
